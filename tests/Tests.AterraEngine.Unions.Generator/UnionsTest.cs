...
public class UnionGeneratorTests : IncrementalGeneratorTest<UnionGenerator> {
    ...
    [LanguageInjection("csharp")] private const string TupleOrFalseOutput = """
        ...
        public readonly partial struct TupleOrFalse {
            public object Value { get; init; } = default!;
            public bool IsTupleOfSuccessOfStringAndNone { get; init; } = false;
            public (TestNamespace.Success<string>, TestNamespace.None) AsTupleOfSuccessOfStringAndNone => ((TestNamespace.Success<string>, TestNamespace.None))Value;
            public bool TryGetAsTupleOfSuccessOfStringAndNone(out (TestNamespace.Success<string>, TestNamespace.None) value) {
                if (IsTupleOfSuccessOfStringAndNone) {
                    value = AsTupleOfSuccessOfStringAndNone;
                    return true;
                }
                value = default;
                return false;
            ...
            public static implicit operator TupleOrFalse((TestNamespace.Success<string>, TestNamespace.None) value) => new TupleOrFalse() {
                Value = value,
                IsTupleOfSuccessOfStringAndNone = true
            };
            public bool IsFalse { get; init; } = false;
            public TestNamespace.False AsFalse => (TestNamespace.False)Value;
            public bool TryGetAsFalse(out TestNamespace.False value) {
